...
public class ProgConstDeclList extends ProgDeclList {

    private ProgDeclList ProgDeclList;
    private ConstDecl ConstDecl;

    public ProgConstDeclList (ProgDeclList ProgDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgConstDeclList(\n");
